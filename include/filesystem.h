...
KAPI b8 filesystem_sizeof(file_handle *handle, u64 *out_size);
...
KAPI b8 filesystem_read_bytes_all(file_handle *handle,
                                  u8 *out_bytes,
                                  u64 *out_bytes_read);

KAPI b8 filesystem_read_text_all(file_handle *handle,
                                 char *out_text,
                                 u64 *out_bytes_read);
